...
class argHandler(dict):
    ...
    def setDefaults(self):
        ...
        self.define('visual_model_name', 'DenseNet121',
                    'select from (VGG16, VGG19, DenseNet121, DenseNet169, DenseNet201, Xception, ResNet50, ResNet101, ResNet152, ResNet50V2, ResNet101V2, ResNet152V2, InceptionV3, InceptionResNetV2, NASNetMobile, NASNetLarge, MobileNet, MobileNetV2). Note that the classifier layer is removed by default.')
        ...
        self.define('positive_weights_multiply', 20.0, 'Controls the class_weight ratio between 0 and 1. Higher value means higher weighting of positive samples. Only works if use_class_balancing is set to true')
